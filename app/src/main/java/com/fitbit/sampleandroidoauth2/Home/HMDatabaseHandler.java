...
/**
 * Created by pag11 on 7/30/2017.
 */

/**
 * This class handles the SQL Lite database
 */
public class HMDatabaseHandler extends SQLiteOpenHelper {
     ...
     * @param userWeight Integer user weight
     * @param userHeight Integer user height
     * @param userTarget String user target
     * @param userAge Integer user age
     * @param desiredWeight Integer desired weight
     * @param noOfWeeks Integer weeks
     * @param goal Double goal calories
     */
    ...
    /**
     * Returns HMUserClass object containing details from user ID
    ...
    /**
     * Returns HMUserClass object containing details from user email
