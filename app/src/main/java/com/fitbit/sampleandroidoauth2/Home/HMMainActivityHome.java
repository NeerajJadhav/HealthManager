...
public class HMMainActivityHome extends AppCompatActivity implements PostRequest.Response {
    ...
    /**
     * Calls the post request method to get response from the nutritionix api
     * @param requestObject JSONObject requestObject
     */
    ...
    /**
     * Opens the Daily Activity Page
     * @param id long id
     * @param myItemInt int myItemInt
     */
    ...
    /**
     * uses the json response and bind it to arraylist
