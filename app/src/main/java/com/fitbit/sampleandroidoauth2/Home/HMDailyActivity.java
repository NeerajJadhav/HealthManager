...
//
    ...
    /**
     * If fitbit connected, take calories burned value from fitbit, else use Step Detector sensor
     * value to calculate calories burned.
     */
    @Override
    ...
    /**
     * Gets values from database and binds to textbox
     */
