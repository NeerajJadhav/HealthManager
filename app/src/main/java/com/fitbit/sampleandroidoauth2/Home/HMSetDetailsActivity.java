...
public class HMSetDetailsActivity extends AppCompatActivity {
    ...
    /**
     *  Calculates nad returns BMR of a user
     * @param gender String user Gender
     * @param weight String user weight
     * @param height String user height
    ...
    /**
     * Calculates and returns Goal of a user
     * @param target String user target
     * @param BMR String user bmr
     * @param desiredWeight String user desiredWeight
     * @param currentWeight String user currentWeight
     * @param noOfWeeks String user noOfWeeks
     * @return
     */
...
//                    editText_weeks.setEnabled(true);
        ...
        if (user != null) {
            ...
            editText_password.setText(HMUserClass.getDecryptedPassword(user.getUserPassword()));
    ...
    /**
     * Freezes or unfreezes Desired Weight and no of weeks text view
     *
     * @param b true enables false disables text view.
     */
        ...
        if (editText_name.getText() != null
            ...
            if (!isEmailValid(name)) {
                ...
                if (user == null) {
                    ...
                    newDb.UpdateUser(Integer.parseInt(this.id), name, HMUserClass.getEncryptedPassword(passwordText), gender, weight, height, target, ageText,
